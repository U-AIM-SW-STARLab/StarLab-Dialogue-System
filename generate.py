...
if __name__ =="__main__":
    ...
    parser.add_argument("--test_set", type=str, default="ann/test_set4DSTC7-AVSD.json")
    parser.add_argument("--lbl_test_set", type=str, default="ann/lbl_undisclosedonly_test_set4DSTC7-AVSD.json")
